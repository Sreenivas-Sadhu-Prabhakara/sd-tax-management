package com.bank.bian.taxmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Corporate Tax Record Procedure".
 *
 ...
 * to its asset type (Corporate Tax Record). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Corporate Tax Record Procedure";
